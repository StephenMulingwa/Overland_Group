-- Overland Group Control Tower — run once against Neon (SQL editor or psql)
...
-- Super Admin (non-deletable) is enforced in app code by email (musyoka@controltech-ea.com): lib/auth/superAdmin.ts
