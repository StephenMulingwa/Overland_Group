...
import { LOGIN_OVERLAY_GRADIENT } from "@/lib/brand";
...
function HeroPanel() {
  return (
    <aside className="relative hidden overflow-hidden lg:block">
      <Image
        src="/overland_login.gif"
        alt="Overland Group fleet"
        unoptimized
        fill
        priority
      ...
      <div
        ...
        style={{ background: LOGIN_OVERLAY_GRADIENT }}
      />
    ...
    <section className="flex min-h-screen items-center justify-center bg-zinc-50 px-6 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-7 shadow-xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm font-medium text-zinc-600">
              Sign in to access the Overland Group Control Tower.
            </p>
          </div>
        ...
        <p className="mt-3 text-center text-[11px] font-medium text-zinc-500">
          © {new Date().getFullYear()} Overland Group
        </p>
      </div>
    </section>
  );
